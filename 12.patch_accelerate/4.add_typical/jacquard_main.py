...
net_path = '/home/ldh/github_repositorys/ggcnn_cornell_dataset/12.patch_accelerate/trained_models/prob'
# 一些训练参数的设定
batch_size = 8
epochs = 100
c_epochs = 40
...
def run():
    ...
    net.load_state_dict(torch.load(os.path.join(net_path,'210910_1905/model0.891_epoch56_batch_8.pth')))
    net = net.to(device)
    # 保存网络和训练参数信息
