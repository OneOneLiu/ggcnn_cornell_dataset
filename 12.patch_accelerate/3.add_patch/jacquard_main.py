...
net_path = '/home/ldh/github_repositorys/ggcnn_cornell_dataset/12.patch_accelerate/trained_models'
# 一些训练参数的设定
batch_size = 8
epochs = 100
c_epochs = 40
...
out_dir = '12.patch_accelerate/trained_models/patch'
...
model_path = 'filter/210911_1927/model0.859_epoch50_batch_8.pth'
model_path = '210911_2040/model0.859_epoch3_batch_8.pth'
logger.info('jacquard')
...
def run():
    # 设置输出文件夹
    out_dir = '12.patch_accelerate/trained_models/'
    dt = datetime.datetime.now().strftime('%y%m%d_%H%M')
    net_desc = '{}_tb'.format(dt)
