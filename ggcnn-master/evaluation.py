...
pretrain = True
load_part = False
model_path = 'output/raw_ggcnn/211124_1204_/epoch_48_iou_0.87_statedict.pt'
...
def run():
    ...
    # 先validate10次
    val_imgs = [args.position,args.ang_cos,args.ang_sin,args.width]
    for i in range(10):
        logger.info('Validating...')
        test_results = validate(net, device, val_data, args.val_batches,val_imgs = val_imgs)
