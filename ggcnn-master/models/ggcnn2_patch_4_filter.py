...
class GGCNN2(nn.Module):
    ...
    def forward(self, x):
        ...
        cos_f = self.filter_cos(self.max_2d(x)) * cos_output
        sin_f = self.filter_sin(self.max_2d(x)) * sin_output
        width_f = self.filter_width(self.max_2d(x)) * width_output
    ...
    def compute_loss(self, xc, yc):
        ...
        # predictions = (pos_pred, cos_pred, sin_pred, width_pred)
        gt_patches,pre_patches = self.get_patch_no_dis(filtered_imgs,y_height)
