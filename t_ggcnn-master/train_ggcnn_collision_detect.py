...
save_folder = os.path.join('output/1.test_ggcnn/', net_desc)
...
def parse_args():
    ...
    parser.add_argument('--ADJ', default = 0, type=int, help='Whether to use ADJ dataset for training')
    parser.add_argument('--ADJV', default = 0, type=int, help='Whether to use ADJ dataset for Validation')
    parser.add_argument('--ADJtrain-path', default = 'train_ADJ.npy',type=str, help='Path to ADJ train dataset')
    parser.add_argument('--ADJtest-path', default = 'test_ADJ.npy',type=str, help='Path to ADJ validation dataset')
