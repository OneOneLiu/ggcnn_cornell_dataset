...
class GGCNN2(nn.Module):
    ...
    def compute_loss(self, xc, yc, include_patch = 1):
        ...
        filtered_cos = filter_cos.relu() * cos_pred
        filtered_sin = filter_sin.relu() * sin_pred
        filtered_width = filter_width.relu() * width_pred
    ...
    def get_patch_no_dis(self,prediction,mask_height):
        ...
        for i in range(batch_size):
            ...
            # for j in range(4):# true_edge = edge * width * 0.01
            #     plt.subplot(2,4,j+5)
