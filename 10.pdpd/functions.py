# -*- coding: utf-8 -*-
"""
Created on Fri May 21 16:18:22 2021
@author: LiuDaohui
"""
...
def post_process(pos_img,cos_img,sin_img,width_img):
    ...
    '''
    q_img = pos_img.numpy().squeeze()
    ang_img = (np.arctan2(sin_img.numpy(), cos_img.numpy()) / 2.0).squeeze()
    width_img = width_img.numpy().squeeze() * 150.0
